...
const TeamMember = ({ img_src, name, position, description, facebook, twitter, linkedin}) => {
  return (
    <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={img_src} alt={name} />
              </a>
              <div className="p-5">
                  ...
                  <ul className="flex space-x-4 sm:mt-0">
                      <li>
                          <a href={facebook} className="text-gray-500 hover:text-gray-900 dark:hover:text-white">

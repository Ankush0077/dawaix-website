...
import LoginImage from '../../assets/img/medicine-home-delivery.jpg';
...
const Login = () => {
  ...
  return (
    ...
    <header style={{/*position: "fixed"*/}}
      className='mb-12 lg:mb-0 z-20 relative px-4 lg:px-0 mt-4'
      data-aos='fade-down'
      data-aos-delay='1200'
    ...
    <section className=" min-h-screen flex items-center justify-center">
      ...
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        ...
        <div className="md:w-1/2 px-8 md:px-16">
          ...
          <p className="text-xs mt-4 text-[#002D74]">Register as a user of DawaiX</p>

          <form action="" className="flex flex-col gap-4">
            <input className="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Email" />
            <input className="p-2 rounded-xl border" type="text" name="email" placeholder="Phone Number" />
        ...
        <div className="md:block hidden w-1/2">
          <img style={{height: '35vh'}} alt='Register' className="rounded-2xl" src={LoginImage} />
        </div>
      </div>
    </section>
    </div>
